            ...
            <form onSubmit={submit} className="mt-6 space-y-6">
                ...
                {mustVerifyEmail && user.email_verified_at === null && (
                    <div>
                        ...
                        {status === "verification-link-sent" && <div className="mt-2 text-sm font-medium text-green-600 dark:text-green-400">A new verification link has been sent to your email address.</div>}
                    </div>
                )}
